...
🌐 **[Live Demo](https://code-explainer.onrender.com)** · 📦 **[GitHub Repo](https://github.com/Dakshjain2006/code-explainer)**
...
```bash
git clone https://github.com/Dakshjain2006/code-explainer.git
cd code-explainer
```
...
Since this app has a backend server, you can deploy it for free on **[Render](https://render.com)**:

### Deploy on Render (Recommended)

1. Push your code to GitHub
2. Go to [render.com](https://render.com) → **New** → **Web Service**
3. Connect your GitHub repo `Dakshjain2006/code-explainer`
4. Configure:
   | Setting | Value |
   |---------|-------|
...
6. Click **Deploy** → Your app will be live at `https://code-explainer.onrender.com` 🚀
...
| **Railway** | ✅ Yes ($5 credit) | [railway.app](https://railway.app) |
| **Vercel** | ✅ Yes | [vercel.com](https://vercel.com) |
| **Fly.io** | ✅ Yes | [fly.io](https://fly.io) |
